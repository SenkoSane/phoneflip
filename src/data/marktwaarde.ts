/** Cheat sheet iPhone 11–17. Schattingen 22 augustus 2026. Verkoop = Marktplaats NL; onderdelen = Fixje / Rounded. */

export const MARKTWAARDE_UPDATED = '2026-08-22'
...
export const WEL_DOEN = [
  ...
  'iPhone 11 scherm kapot: meestal max €60. Scherm + slechte accu is lager of skip — te krap.',
